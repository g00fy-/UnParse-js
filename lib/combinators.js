...
var pInteger = fmap(function(xs) {return parseInt(xs.join(''), 10);}, many1(basic.oneOf('0123456789'))),
    plus     = basic.literal('+'),
    pPlus    = app(function(x, y, z) {return x + z;}, pInteger, plus, pInteger);
...
var pPlus2   = app(f, pInteger, many0(app(g, plus, pInteger)));
//    'pChainL'    : 
